    ...
    <div class="container-fluid">
                            ...
                            <div id="columna" class="col-md-6">
                                <div id="caja" class="col-md-12">
                                    <form id="form" class="form" action="" method="post">
                                        <br/>
                                        <h2 class="text-center text-info">Borrar Tarea</h2>
                                        <div class="form-group">
                                            <label for="title" class="text-info">Título:</label><br>
                                            <input type="text" name="title" id="title" placeholder="" class="form-control" value="<?php echo $task->getTitle();?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="descr" class="text-info">Descripción:</label><br>
                                            <textarea type="textarea" name="descr" id="descr" placeholder="" style="height: 12em; resize: none;" class="form-control" readonly><?php echo $task->getDescr();?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="cat" class="text-info">Categoría:</label><br>
                                            <input type="text" name="title" id="title" placeholder="" class="form-control" value="<?php echo $task->getCat();?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="status" class="text-info">Estado:</label><br>
                                            <input type="text" name="title" id="title" placeholder="" class="form-control" value="<?php echo $task->getStatus();?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="urg" class="text-info">Urgencia:</label><br>
                                            <input type="text" name="title" id="title" placeholder="" class="form-control" value="<?php echo $task->getUrg();?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <br/>
                                            <input type="submit" name="deletetask" class="btn btn-danger btn-md" value="Borrar Tarea">
        ...
        <?php
                ...
                if (isset($_POST['deletetask'])) {
                    $controller = new tareas_controller();
                    $controller->borrar_tarea($_GET['id']);

                    header("Location: exito_d.php");
